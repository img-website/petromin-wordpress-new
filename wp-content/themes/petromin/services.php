...
<div class="hero_section w-full relative z-0 md:min-h-dvh h-dvh md:!h-auto">
    <div class="relative w-full h-full overflow-hidden">
        ...
        <div class="absolute flex flex-col lg:bottom-32 md:bottom-24 bottom-20 left-0 view text-white">
            <h1 class="xl:text-6xl md:text-5xl text-[2.625rem] font-bold leading-tight flex md:w-[52rem] flex-wrap items-center gap-2">
                <?php echo esc_html($hero_data['heading_prefix']); ?>
                <span class="bg-gradient-to-l from-[#CB122D] to-[#650916] md:ml-2 md:h-[4.688rem] md:w-[18.25rem] inline-block px-2 flex justify-center -skew-x-[18deg]">
        ...
        <div class="w-full relative overflow-hidden">
            <div class="flex items-center justify-between pb-[3.25rem] md:pb-[3.188rem]">
                <div class="w-full relative">
                    ...
                    <div class="relative md:pt-4 pt-1.5 after:absolute after:bg-gradient-to-l from-[#CB122D] via-[#CB122D] to-[#650916] after:w-[6.75rem] md:after:h-3 after:h-[0.688rem] after:-skew-x-[18deg] after:left-0"></div>
                </div>
                <div class="flex items-center justify-start md:flex hidden origin-bottom z-20 bg-[#CB122D] px-4 shadow-[-6px_6px_0px_-1px_rgba(0,0,0,0.9)] w-[10.313rem] h-16 transition transform -skew-x-12 duration-150 ease-in-out">
                        ...
                        <?php foreach ($our_services_data['slides'] as $slide) : ?>
                            <div class="swiper-slide !h-auto">
                                <a href="<?php echo esc_url($slide['service_link']); ?>" class="w-full">
                                    <div class="w-full relative overflow-hidden h-full group duration-500">
                                        <?php if (!empty($slide['slide_image']['url'])) : ?>
                                            <img fetchpriority="low" loading="lazy" 
                                                 ...
                                                 class="size-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-110" />
                                        <?php endif; ?>
                                        
                                        <div class="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-[#CB122D] to-[#CB122D00] transition-all duration-500 ease-in-out group-hover:h-2/4"></div>
    ...
    <div class="pt-[4.438] md:pt-[11.188rem]">
        <div class="relative overflow-hidden">
            <div class="flex md:flex-row flex-col h-[42.063rem] md:h-[36.125rem] items-center">
                ...
                <div class="px-2 md:w-3/4 md:-skew-x-[12deg] origin-top relative bg-gradient-to-r h-full from-[#ffffff] to-[#e5e5e5]">
                    <div class="flex flex-col justify-center h-full w-full md:pt-0 pt-10 pl-7 md:pl-32 md:skew-x-[12deg]">
                        <h2 class="text-[1.75rem] max-w-xl sm:text-4xl md:text-[3.125rem] font-bold text-black text-balance !leading-tight">
                        ...
                        <ul class="md:mt-14 mt-7 space-y-4">
                            <?php foreach ($features_data['features_list'] as $feature) : ?>
                                <li class="flex items-center gap-3 md:text-[1.188rem] text-sm font-semibold text-black">
                                    <!-- check icon -->
                                    <svg width="32" height="32" class="shrink-0 size-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <div class="relative w-full md:w-1/3 bg-gradient-to-r from-[#ffffff] to-[#e5e5e5] flex items-center h-full justify-center px-4 md:px-0">
                    <div class="absolute -right-10 top-0 w-[12.5rem] md:w-[41.188rem] transform origin-bottom md:h-[36.125rem] h-[24.813rem] -skew-x-[12deg] bg-gradient-to-r from-[#8b0f15] to-[#CB122D]"></div>

                    <div class="absolute md:w-[50rem] px-8 md:px-0 md:right-[4.813rem] max-sm-[22.938rem] flex justify-center items-center h-[20.188rem] md:h-[25.313rem]">
...
<section class="w-full taptrack bg-white pt-[6.313rem] md:pt-[3.938rem]">
    <div class="view relative before:absolute before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:w-full before:h-28 before:bg-gradient-to-t before:from-[#FBFCFD] before:to-[#FBFCFD00]">
                ...
                <div class="flex items-center gap-6 mt-3">
                    <?php if (!empty($app_data['app_store_badges']['play_store_image']['url'])) : ?>
                        <a href="<?php echo esc_url($app_data['app_store_badges']['play_store_link']); ?>">
                            <img class="md:h-[4rem] h-[3.125rem]" 
...
<section class="commonly bg-white relative w-full pt-[5.813rem] pb-20">
    <div class="view flex flex-col md:gap-y-12 gap-y-8" id="commonlyAccordion">
        <div class="w-full relative">
            ...
            <div class="relative pt-3 after:absolute after:bg-gradient-to-l from-[#CB122D] via-[#CB122D] to-[#650916] after:w-[6.75rem] md:after:h-3 after:h-[0.688rem] after:-skew-x-[18deg] after:left-0"></div>
        </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 md:gap-5">
                    <?php foreach ($faq_data['faq_items'] as $index => $faq) : ?>
                        <div class="accordion-item border border-black">
                            <button class="commonly-header w-full px-6 py-4 flex justify-between items-center text-left font-semibold <?php echo $faq['is_active'] ? 'text-[#CB122D]' : 'text-gray-800'; ?>">
                                <span class="md:text-xl text-base font-semibold"><?php echo esc_html($faq['question']); ?></span>
                                <span class="shirnk-0 commonly-icon text-white bg-[#CB122D] size-6 flex items-center justify-center">
                                    <?php echo $faq['is_active'] ? '−' : '+'; ?>
                                </span>
                            </button>
                            <div class="commonly-body px-6 pb-4 pt-2 text-base md:text-sm text-[#010101] font-normal <?php echo $faq['is_active'] ? '' : 'hidden'; ?>">
